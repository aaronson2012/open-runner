...
export class Rattlesnake extends Enemy {
    ...
    _updateAnimation(elapsedTime, isMoving, currentSpeed) {
     ...
     _updateGrounding() {
        ...
        _rayOrigin.set(currentPosition.x, currentPosition.y + enemyDefaultsConfig.GROUNDING_OFFSET_SNAKE, currentPosition.z);
        ...
        if (intersects.length > 0) {
            ...
            const modelHeight = enemyDefaultsConfig.GROUNDING_HEIGHT_SNAKE;
