import{S as e}from"./index-Darn3lB3.js";import"./logDepthDeclaration-C2X_TtNl.js";import"./helperFunctions-BXULrI63.js";import"./meshUboDeclaration-Bb5luTlK.js";const o="decalFragmentDeclaration",P=`#ifdef DECAL
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=O);const s="clusteredLightingFunctions",y=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};ClusteredLight getClusteredLight(sampler2D lightDataTexture,int index) {return ClusteredLight(
...
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=y);const d="lightsFragmentFunctions",b=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=b);const c="shadowsFragmentFunctions",_=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=_);const h="samplerFragmentDeclaration",U=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=z);const m="imageProcessingFunctions",G=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=G);const g="bumpFragmentMainFunctions",V=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=V);const S="bumpFragmentFunctions",B=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=B);const C="fogFragmentDeclaration",k=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=k);const E="bumpFragment",Y=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=Y);const D="decalFragment",$=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=Z);const I="lightFragment",q=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=q);const T="logDepthFragment",Q=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=Q);const w="fogFragment",j=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=j);const A="oitFragment",J=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=J);const i="defaultPixelShader",x=`#define CUSTOM_FRAGMENT_EXTENSION
