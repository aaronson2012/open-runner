import{S as e}from"./index-Darn3lB3.js";const t="bonesDeclaration",l=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=x);const a="clipPlaneVertexDeclaration",T=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=T);const f="morphTargetsVertexGlobal",p=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
var vertexID : f32;
#endif
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=p);const s="morphTargetsVertex",E=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=E);const d="instancesVertex",S=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=S);const o="bonesVertex",v=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
