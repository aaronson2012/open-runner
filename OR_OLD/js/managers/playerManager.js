...
class PlayerManager extends BaseManager {
    ...
    setupEventSubscriptions() {
        this.subscribeToEvent('powerupCollected', this.handlePowerupCollected.bind(this));
        this.subscribeToEvent('resetPowerups', this.resetPowerups.bind(this));
...
export function resetPlayerManager() {
    if (playerManagerInstance) {
        playerManagerInstance.cleanupManager();
